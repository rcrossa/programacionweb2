    ...
    <section class="container-fluid">
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                    <h2>Usuahia, Argentina</h2>
                        <div class="card" style="fluid">
                            <img class="card-img-top" src="imagenes/cerrocastor.png" alt="Card image" style="width:100%">
                            <div class="card-body">
                                <h4 class="card-title">$50000</h4>
                                <p class="card-text">Un lugar perfecto para esquiar, disfrutá tu país, disfrutá Chubut</p>
                                <a href="#" class="btn btn-primary">Ver Oferta</a>
                            </div>
                        </div>
                </div>
        ...
        <div class="container-fluid" id="tab-content">
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
                    <div class="tab-3"><a class="text-light" href="http://www.aa2000.com.ar/" target="_blank">Arribos y Partidas</a></div>
                </div>
                <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
                    <div class="tab-5"><a class="text-light" href="egresoconmenores/egresoconmenores.html">Egreso Del País Con Menores</a></div>
                </div>
            </div>
