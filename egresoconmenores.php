    ...
    <section>
        <div class="container-fluid">
            <div class="row">
                <div class="container">
                    <div>
                        <h1 class="col-xs-12 col-sm-12 col-md-12 col-lg-12">Egreso Del País Con Menores</h1>
                    </div>
                </div>
            </div>
            <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <div class="parrafo1">
                                ...
                                <ul>
                                    ...
                                    <li>Si el menor viaja con uno solo de los padres, la documentación (1) requerida será:
                                        <p> - Autorización expresa del progenitor que no viaja, en la que conste que el menor viaja acompañado por el otro progenitor especificándose obligatoriamente los datos personales (nombre y apellido, tipo y nro. de documento.), o
                                ...
                                <ul>
                                    <li>
                                        ...
                                        <p>- Libreta de Matrimonio con la defunción del cónyuge asentada y con el nacimiento asentado, o
                                    ...
                                    <li>
                                        ...
                                        <p>- Autorización expresa de ambos padres, por escrito*.
                                ...
                                <p><strong>En todos los casos, es deber de los pasajeros verificar que la documentación esté en regla, no se encuentre en mal estado ni rota, así como controlar e informarse con los Consulados respectivos de los países a los que emprende el viaje cuál es la documentación necesaria para el ingreso a país de destino. Recordar que la línea aérea tiene facultades para denegar el transporte en caso que no cumpla con los recaudos de viaje (cfr. Art. 8º Res. 15323/98), haciendo pasible al pasajero de las penalidades prescriptas en el contrato de transporte.</strong></p>


                                <p><strong>A los fines ilustrativos, se recomienda la lectura de <a href="http://www.infojus.gob.ar/descarga-archivo?guid=klmnoprs-tuvw-nove-dade-scf150487pdf&name=cf150487.pdf" target="_blank"> Aqui</a></strong></p>
                            </div>
                        </div>
                    </div>
                </div>
